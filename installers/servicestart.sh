...
#mp035: I found that the wifi interface would stop every 8 seconds
# for about 16 seconds.   Reassociating seems to solve this issue.
if [ "${config[WifiAPEnable]}" = 1 ]; then
    echo "Reassociating wifi client interface after bringing up Raspap....."
    sleep "${seconds}"
